...
topics: ["tech", "riscv", "fpga", "Linux", "Embedded"]
published: true
---
...
`\build\digilent_arty\gateware` に Vivado の Project 一式があるので、Windows 側の Vivado Hardware Manager で `digilent_arty.bin` を 書き込む。
