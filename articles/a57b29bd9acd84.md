...
- [tinyusb msc_disk](https://github.com/hathach/tinyusb/blob/master/examples/device/cdc_msc/src/msc_disk.c#L52) のサンプルと同様に、FAT12 Table の内容を RAM 上の初期値に設定
...
- Read Capacity で Last Logical Block Address に Num of Block 相当の値を報告していた (Device 内部の最大 LBA+1block のアクセスが飛んでくる)
